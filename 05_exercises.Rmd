...
```
```{r}
knitr::include_graphics("garden2.gif")
```
...
```{r}
knitr::include_graphics("covidstates2.gif")
```
...
## GitHub link
  ...
  [https://github.com/ocoing05/data-science-weekly-exercise-5](https://github.com/ocoing05/data-science-weekly-exercise-5)
